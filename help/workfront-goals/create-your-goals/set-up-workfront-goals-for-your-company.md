...
* Votre organisation doit acheter une licence [!DNL Workfront Goals], en plus de la licence [!DNL Workfront].
...
* Vous devez affecter un modèle de mise en page qui comprend la zone [!DNL Workfront Goals] dans le menu principal pour permettre aux utilisateurs et utilisatrices d’accéder à la fonctionnalité.
