...
+ Administration et configuration {#administration-and-setup}
   + Configuration organisationnelle {#organizational-setup}
   ...
   + Configuration des paramètres système par défaut {#configure-system-defaults}
      + [Création et gestion des états d’objet](administration-and-setup/configure-system-defaults/create-and-manage-object-statuses.md)
      + [Présentation des types de problèmes par défaut](administration-and-setup/configure-system-defaults/default-issue-types.md)
      + [Création d’un état de problème](administration-and-setup/configure-system-defaults/create-an-issue-status.md)
      + [Créer un état des problèmes à l’échelle du système](administration-and-setup/configure-system-defaults/customize-systemwide-issue-status.md)
      + [Création et gestion des plannings](administration-and-setup/configure-system-defaults/create-and-manage-schedules.md)
      + [Création et gestion des statistiques sur les problèmes](administration-and-setup/configure-system-defaults/create-and-manage-issue-severities.md)
      ...
      + [Configuration des paramètres globaux par défaut du projet](administration-and-setup/configure-system-defaults/configure-global-default-project-settings.md)
   ...
   + Modèles de disposition {#layout-templates}
      ...
      + [Personnalisation des détails d’un projet avec des modèles de mise en page](administration-and-setup/layout-templates/customize-project-details-with-layout-templates.md)
      + [Personnalisation des en-têtes de projet avec des modèles de mise en page](administration-and-setup/layout-templates/customize-project-headers-with-layout-templates.md)
      + [Personnalisation des listes de rapports avec des modèles de mise en page](administration-and-setup/layout-templates/customize-reporting-lists-with-layout-templates.md)


   + Notifications par e-mail et in-app {#email-and-in-app-notifications}
      + [Gestion des notifications in-app et par e-mail](administration-and-setup/email-and-in-app-notifications/manage-inapp-and-email-notifications.md)
      + [Configuration des notifications d’événement](administration-and-setup/email-and-in-app-notifications/admin-set-up-event-notifications.md)
      ...
      + [Configuration des notifications de rappel](administration-and-setup/email-and-in-app-notifications/admin-create-reminder-notifications.md)
      ...
      + [Configuration de rappels automatiques](administration-and-setup/email-and-in-app-notifications/admin-set-up-automatic-reminders.md)
      + [S’abonner à des tâches](administration-and-setup/email-and-in-app-notifications/user-subscribe-to-work-items.md)
...
+ Données personnalisées {#custom-data}
   ...
   + Expressions calculées {#calculated-expressions}
      + [Prise en main des champs et expressions calculés](custom-data/calculated-expressions/get-started-with-calculated-fields-and-expressions.md)
      + [Découvrez la structure de l’expression de données](custom-data/calculated-expressions/data-expression-structure.md)
      + [Présentation des expressions de date et heure et mathématiques](custom-data/calculated-expressions/date-and-time-and-mathematical-expressions.md)
      + [Créez des expressions ADDDAYS, ADDWEEKDAY, ADDMONTHES, ADDYEARS](custom-data/calculated-expressions/create-adddays-addweekdays-addmonths-addyears-expressions.md)
      + [Utilisation de l’éditeur de calcul](custom-data/calculated-expressions/use-the-calculation-editor.md)
      + [Création d’expressions DATEDIFF et WEEKDAYDIFF](custom-data/calculated-expressions/create-datediff-and-weekdaydiff-expressions.md)
      + [Créer une expression de données SOB, SUM, DIV ou PROD](custom-data/calculated-expressions/create-a-sub-sum-div-or-prod-data-expression.md)
      ...
      + [Création d’expressions GAUCHE/DROITE](custom-data/calculated-expressions/create-left-right-expressions.md)
      + [Utiliser les expressions ISBLANK et CONTAINS](custom-data/calculated-expressions/isblank-and-contains.md)
      + [Création d’une expression de texte IF](custom-data/calculated-expressions/create-an-if-text-expression.md)
...
+ Gérer le travail {#manage-work}
   ...
   + Tâches {#tasks}
      ...
      + [Comprendre [!UICONTROL Effort professionnel]](manage-work/tasks/understand-work-effort.md)
   ...
   + Processus de validation et chemins de jalon {#approval-processes-and-milestone-paths}
      ...
      + [Délégation de tâches, de problèmes et de validations](manage-work/approval-processes-and-milestone-paths/delegate-approvals.md)
      + [Affichage des jalons](manage-work/approval-processes-and-milestone-paths/view-milestones.md)
   ...
   + Chronologies du projet {#project-timelines}
      ...
      + [Suivi de la progression à partir de la chronologie du projet](manage-work/project-timelines/track-work-progress-from-the-project-timeline.md)

   + Fermeture d’un projet {#close-a-project}
      + [Fermeture d’un projet](manage-work/close-a-project/close-a-project-in-workfront.md)
      + [Modifier l’état du projet pour qu’il soit terminé](manage-work/projects/change-the-project-status.md)
      + [Fermeture des tâches et des problèmes](manage-work/close-a-project/close-tasks-and-issues.md)
   ...
   + Finances du projet pour les utilisateurs {#project-finances-users}
...
+ Rapports {#reporting}
   + Reporting de base {#basic-reporting}
      ...
      + [Créer un groupement de base](reporting/basic-reporting/create-a-basic-grouping.md)
      + [Créer une vue de base](reporting/basic-reporting/create-a-basic-view.md)
      + [Ajouter une mise en forme conditionnelle de base](reporting/basic-reporting/add-basic-conditional-formatting-to-a-view.md)
      ...
      + [Envoi et partage de rapports](reporting/basic-reporting/how-to-send-and-share-reports.md)
      + [Présentation des paramètres des rapports](reporting/basic-reporting/report-settings.md)
      + [Présentation de l’interface du calendrier](reporting/basic-reporting/tour-of-the-interface.md)
      + [Création d’un calendrier personnalisé](reporting/basic-reporting/creating-custom-calendars.md)
      + [Présentation des options de calendrier supplémentaires](reporting/basic-reporting/additional-calendar-options.md)
      + [Votre tour de créer un calendrier](reporting/basic-reporting/your-turn-to-create-a-calendar.md)

   + Rapport intermédiaire {#intermediate-reporting}
      + [Création de filtres avec des caractères génériques basés sur l’utilisateur](reporting/intermediate-reporting/create-filters-with-user-based-wildcards.md)
      + [Création de filtres avec des caractères génériques basés sur la date](reporting/intermediate-reporting/create-filters-with-date-based-wildcards.md)
      + [Création d’instructions OU dans des filtres](reporting/intermediate-reporting/or-statements-in-filters.md)
      + [Présentation des filtres de projet intégrés](reporting/intermediate-reporting/open-built-in-project-filters.md)
   ...
   + Création de rapports avancés {#advanced-reporting}
      ...
      + [Création de rapports avancés, partie 3](reporting/advanced-reporting/advanced-reporting-part-3.md)
   ...
   + Analytique améliorée {#enhanced-analytics}
      ...
      + [Comprendre les graphiques du travail et des personnes](reporting/enhanced-analytics/5-work-and-people-charts.md)
      + [Présentation des filtres](reporting/enhanced-analytics/6-filters-overview.md)
      + [Comprendre les périodes et les délais](reporting/enhanced-analytics/7-date-ranges-vs-timeframes.md)
      + [Présentation des heures planifiées et des vues de durée](reporting/enhanced-analytics/8-planned-hours-and-duration-views.md)
      + [Comprendre les actions : cliquez avec le bouton de la souris et faites glisser et cliquez dessus.](reporting/enhanced-analytics/9-actions-hover-click-and-drag-and-click-in.md)
      + [Présentation des indicateurs de performance clés](reporting/enhanced-analytics/10-kpis-overview.md)
      + [Comprendre la navigation et la révision des projets](reporting/enhanced-analytics/11-navigating-and-reviewing-projects.md)
      + [Exploration plus approfondie à l’aide des délais et des graphiques supplémentaires](reporting/enhanced-analytics/12-digging-deeper-using-timeframes-and-additional-charts.md)
      ...
      + [Exploration plus approfondie de la navigation](reporting/enhanced-analytics/14-navigation-and-digging-deeper.md)
      + [Comprendre l’accès et la révision de la ventilation](reporting/enhanced-analytics/15-accessing-and-reviewing-the-burndown.md)
      + [Vérification des tâches en cours](reporting/enhanced-analytics/16-navigating-to-and-reviewing-the-tasks-in-flight.md)
      + [Agir en effectuant des mises à jour](reporting/enhanced-analytics/17-taking-action-by-making-updates.md)
      + [Comprendre l’activité par graphique d’équipe](reporting/enhanced-analytics/18-activity-by-team-chart.md)
      + [Comprendre le graphique de la capacité des ressources](reporting/enhanced-analytics/19-resource-capacity-chart.md)
      + [Comprendre les capacités de l’équipe](reporting/enhanced-analytics/20-team-capacity-overview.md)
      + [Présentation d’un cas pratique de comparaison des indicateurs de performance clés](reporting/enhanced-analytics/21-kpi-comparisons.md)
      + [Présentation d’un cas d’utilisation utilisateur final](reporting/enhanced-analytics/22-end-user-use.md)
      + [Présentation des conseils](reporting/enhanced-analytics/23-consulting-guidance.md)
...
+ Gestion des ressources {#manage-resources}
   ...
   + Équilibreur de charge de travail {#workload-balancer}
      + [Recherche de l’équilibreur de charge](manage-resources/workload-balancer/find-the-workload-balancer.md)
      ...
      + [Affichage des affectations utilisateur dans l’équilibreur de charge de travail](manage-resources/workload-balancer/view-user-allocations.md)
   ...
   + Planification des ressources {#resource-planning}
      + [Qu’est-ce que le planificateur de ressources ?](manage-resources/resource-planning/what-is-the-resource-planner.md)
      + [Utilisation des vues](manage-resources/resource-planning/view-utlization-intro-filter-the-resource-planner.md)
      + [Affichage par les utilisateurs](manage-resources/resource-planning/view-by-users/view-by-users.md)
      + [Afficher par rôle de tâche](manage-resources/resource-planning/view-by-job-role/view-by-job-role.md)
      + [Afficher par projet](manage-resources/resource-planning/view-by-project/view-by-project.md)

   + Calendrier des heures de désactivation personnelles {#personal-time-off-calendar}
      + [Pourquoi utiliser le calendrier des heures de congé ?](manage-resources/pto/why-use-time-off-calendar.md)
      + [Comment le délai d’expiration affecte-t-il les calendriers du projet](manage-resources/pto/how-time-off-affects-project-timelines.md)
      + [Gestion des autres interruptions de service des utilisateurs](manage-resources/pto/manage-other-users-time-off.md)
   ...
   + Planificateur de scénarios {#scenario-planner}
      ...
      + [Ajuster les informations sur le rôle, le budget et les coûts de la tâche dans le planificateur de scénario](manage-resources/scenario-planner/adjust-job-role-budget-and-cost-information-in-the-scenario-planner.md)
...
+ Objectifs Workfront {#workfront-goals}
   + Définition d’une vision pour votre organisation {#establish-a-vision-and-strategy}
      ...
      + [Définition d’une vision et d’une stratégie pour votre organisation](workfront-goals/establish-a-vision-for-your-org/establish-a-vision-and-strategy.md)
   ...
   + Activation de vos objectifs {#activate-goals}
      + [Activation des objectifs](workfront-goals/activate-your-goals/activate-goals-in-workfront.md)
      ...
      + [Ajout d’une activité et d’un projet à un objectif](workfront-goals/activate-your-goals/add-an-activity-to-a-goal.md)
   ...
   + Gérer vos objectifs {#manage-goals}
      ...
      + [Mise à jour de la progression des résultats et des activités](workfront-goals/manage-your-goals/make-a-quantitative-update.md)
...
+ Intégrations {#integrations}
   + Adobe Creative Cloud {#adobe-creative-cloud}
      + [Utilisation des modules externes Adobe Workfront pour l’intégration à Creative Cloud](integrations/adobe-creative-cloud/use-adobe-workfront-extensions-for-creative-cloud.md)
   ...
   + Adobe Experience Manager Assets Essentials {#adobe-assets-essentials}
      ...
      + [Envoi de documents et liaison de ressources](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/link-send.html)
      + [Historique des versions](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/versions.html)

   + Suite G {#g-suite-integrations}
      + [Amélioration de votre workflow avec l’intégration de G Suite](integrations/g-suite-integrations/worfront-for-g-suite-integrations.md)
   ...
   + Microsofts Teams {#ms-teams}
      ...
      + [Installation d’Adobe Workfront for Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/install-workfront-ms-teams.html)
...
+ Fusion {#fusion}
   + Bienvenue dans Workfront Fusion {#welcome-to-workfront-fusion}
      ...
      + [Connexion en tant que nouvel utilisateur](fusion/1-welcome-to-workfront-fusion/log-in-as-a-new-user.md)
      + [Présentation de la formation à Workfront Fusion](fusion/1-welcome-to-workfront-fusion/workfront-fusion-overview.md)
      + [Configuration de vos fichiers d’exercice Workfront Fusion](fusion/1-welcome-to-workfront-fusion/set-up-your-fusion-exercise-files-walkthrough.md)
   ...
   + Comprendre les concepts de base {#understand-the-basics}
      + [Présentation de la conception initiale du scénario](fusion/2-understand-the-basics/initial-scenario-design-walkthrough.md)
      ...
      + [Au-delà de la présentation du mapping de base](fusion/2-understand-the-basics/beyond-basic-mapping-walkthrough.md)
      + [Utilisation des filtres](fusion/2-understand-the-basics/use-filters.md)
      + [Présentation des filtres](fusion/2-understand-the-basics/filters-walkthrough.md)
      + [Accès à la présentation des versions précédentes](fusion/2-understand-the-basics/access-previous-versions-walkthrough.md)

   + Connecteurs et routage universels {#universal-connectors-and-routing}
      + [Présentation de l’exercice des connecteurs universels](fusion/3-universal-connectors-and-routing/universal-connectors-exercise-overview.md)
      ...
      + [Présentation détaillée des variables Get/set](fusion/3-universal-connectors-and-routing/get-set-variables-walkthrough.md)
   ...
   + Itération et agrégation {#iteration-and-aggregation}
      ...
      + [Présentation détaillée des itérateurs](fusion/4-iteration-and-aggregation/introduction-to-iterators-walkthrough.md)
      + [Présentation des agrégations](fusion/4-iteration-and-aggregation/introduction-to-aggregations.md)
      + [Présentation de l’agrégation](fusion/4-iteration-and-aggregation/aggregation-walkthrough.md)
      + [Présentation de l’agrégation avancée](fusion/4-iteration-and-aggregation/advanced-aggregation-walkthrough.md)

   + Historique et planification de l&#39;exécution {#execution-history-and-scheduling}
      + [Présentation de l’historique d’exécution](fusion/5-execution-history-and-scheduling/introduction-to-execution-history.md)
      ...
      + [cycles d’exécutions des équilibres et lots](fusion/5-execution-history-and-scheduling/balance-runs-cycles-and-bundles.md)
      + [Présentation des cycles et des lots d’exécution](fusion/5-execution-history-and-scheduling/runs-cycles-and-bundles-walkthrough.md)
   ...
   + Au-delà des modules de base {#beyond-basic-modules}
      ...
      + [Basculer](fusion/6-beyond-basic-modules/switch-it-up.md)
      + [Présentation de la fonction Switch](fusion/6-beyond-basic-modules/switch-function-walkthrough.md)
      + [Présentation du module Switch](fusion/6-beyond-basic-modules/switch-module-walkthrough.md)
      + [Comprendre le monde des webhook](fusion/6-beyond-basic-modules/understand-the-webhook-world.md)
      + [Présentation détaillée de Webhooks](fusion/6-beyond-basic-modules/webhooks-walkthrough.md)

   + Structures de données et entrepôts de données {#data-structures-and-data-stores}
      + [Présentation des structures de données](fusion/7-data-structures-and-data-stores/understand-data-structures.md)
      + [Présentation des structures de données](fusion/7-data-structures-and-data-stores/data-structures-walkthrough.md)
      + [Présentation des entrepôts de données](fusion/7-data-structures-and-data-stores/understand-data-stores.md)
      + [Présentation des entrepôts de données](fusion/7-data-structures-and-data-stores/data-stores-walkthrough.md)

   + Bits et bobines fonctionnels finaux {#final-functional-bits-and-bobs}
   ...
   + Dépannage et gestion des erreurs {#troubleshooting-and-error-handling}
      ...
      + [Comprendre les directives de gestion des erreurs](fusion/9-troubleshooting-and-error-handling/understand-error-handling-directives.md)
      + [Présentation de la gestion des erreurs](fusion/9-troubleshooting-and-error-handling/error-handling-walkthrough.md)
      + [Comprendre les exécutions incomplètes](fusion/9-troubleshooting-and-error-handling/understand-incomplete-executions.md)
      + [Présentation des exécutions incomplètes](fusion/9-troubleshooting-and-error-handling/incomplete-executions-walkthrough.md)
   ...
   + Optimisation et test de la conception {#design-optimization-and-testing}
      + [Définir des cas d’utilisation distincts et rechercher la meilleure approche](fusion/11-design-optimization-and-testing/define-distinct-use-cases-and-find-the-best-approach.md)
      + [Optimisation du scénario de fusion Workfront](fusion/11-design-optimization-and-testing/workfront-fusion-scenario-optimization.md)
      + [Accessibilité et clarté](fusion/11-design-optimization-and-testing/accessibility-and-clarity.md)
      + [Barrières de sécurité du scénario](fusion/11-design-optimization-and-testing/scenario-guardrails.md)
      + [Tests et lancement](fusion/11-design-optimization-and-testing/testing-considerations.md)
   + Exercices {#exercises}
      + [Conception initiale du scénario](fusion/12-exercises/initial-scenario-design.md)
      + [Au mappage de base](fusion/12-exercises/beyond-basic-mapping.md)
      + [Filtres](fusion/12-exercises/filters.md)
      + [Accès aux versions précédentes](fusion/12-exercises/access-previous-versions.md)
      + [Présentation des connecteurs universels](fusion/12-exercises/introduction-to-universal-connectors.md)
      + [Routeurs](fusion/12-exercises/routers.md)
      + [Modèles de routage](fusion/12-exercises/routing-patterns.md)
      + [Définir/Obtenir des variables](fusion/12-exercises/set-get-variables.md)
      + [Présentation des itérateurs](fusion/12-exercises/introduction-to-iterators-exercise.md)
      + [Agrégation](fusion/12-exercises/aggregation.md)
      + [Agrégation avancée](fusion/12-exercises/advanced-aggregation.md)
      + [Historique d&#39;exécution](fusion/12-exercises/execution-history.md)
      + [Exploration des exécutions, des cycles et des lots](fusion/12-exercises/exploring-runs-cycles-and-bundles.md)
      + [Fonction Switch](fusion/12-exercises/switch-function.md)
      + [Module de basculement](fusion/12-exercises/switch-module.md)
      + [Webhooks](fusion/12-exercises/webhooks.md)
      + [Structures de données](fusion/12-exercises/data-structures.md)
      + [Entrepôts de données](fusion/12-exercises/data-stores.md)
...
+ Workfront Proof {#workfront-proof}
   ...
   + Administration et configuration {#administration-and-setup-for-proof}
      + [Qu’est-ce qu’un modèle de workflow automatisé ?](workfront-proof/administration-and-setup/what-is-an-automated-workflow-template.md)
   ...
   + Téléchargement de BAT {#upload-proofs}
      ...
      + [Affichage et comparaison des versions de BAT](workfront-proof/upload-proofs/view-and-compare-proof-versions.md)
      + [Téléchargement d’une version de BAT](workfront-proof/upload-proofs/upload-a-proof-version.md)
      + [Gestion des versions de BAT](workfront-proof/upload-proofs/manage-proof-versions.md)
      + [Chargement d’un BAT d’une vidéo](workfront-proof/upload-proofs/other-types-of-digital-assets.md)
      + [Télécharger un bon à tirer d’un site web](workfront-proof/upload-proofs/upload-a-proof-of-a-website.md)
      + [Chargement d’un BAT avec un workflow de base](workfront-proof/upload-proofs/upload-a-proof-with-a-basic-workflow.md)
      + [Chargement d’un BAT avec un workflow automatisé](workfront-proof/upload-proofs/upload-a-proof-with-an-automated-workflow.md)
      + [Chargement avec un glisser-déposer](workfront-proof/upload-proofs/upload-with-a-drag-and-drop.md)
   ...
   + Workflows de BAT {#proof-workflows}
      + [Présentation des workflows de BAT dans les calendriers du projet](workfront-proof/proof-workflows/understand-and-create-proof-workflows.md)
      + [Modification d’un workflow de BAT](workfront-proof/proof-workflows/edit-a-proof-workflow.md)
   ...
   + Réviser et approuver le travail {#review-and-approve-work-for-proof}
      + [Navigation dans la visionneuse de BAT](workfront-proof/review-and-approve-work/navigate-the-proof-viewer.md)
      + [Vérifier et approuver un BAT](workfront-proof/review-and-approve-work/review-and-approve-a-proof.md)
      + [Réviser et répondre aux commentaires du BAT](workfront-proof/review-and-approve-work/review-and-respond-to-proof-comments.md)
      + [Révision d’une vidéo avec un BAT](workfront-proof/review-and-approve-work/review-a-video-with-proof.md)
      + [Consulter un site web avec un BAT](workfront-proof/review-and-approve-work/review-a-website-with-proof.md)
      + [Présentation des détails du BAT](workfront-proof/review-and-approve-work/proof-details-overview.md)
...
+ Workfront DAM {#workfront-dam-program}
   + Configuration du système {#system-setup}
      ...
      + [Analysez et planifiez une [!DNL Workfront DAM] stratégie](workfront-dam/system-setup/analyze-and-plan-to-develop-a-workfront-dam-strategy.md)
      + [Configuration de groupes et d’utilisateurs](workfront-dam/system-setup/system-setup-groups-and-users.md)
      + [Configuration de l’intégration dans Workfront](workfront-dam/system-setup/configure-the-integration-in-workfront.md)
   ...
   + Métadonnées et mots-clés {#metadata-and-keywords}
      + [Présentation des métadonnées](workfront-dam/metadata-and-keywords/metadata-introduction.md)
      ...
      + [Vérification de la terminologie des métadonnées](workfront-dam/metadata-and-keywords/review-the-terminology.md)
      + [Recherche de ressources à l’aide de métadonnées et de mots-clés](workfront-dam/metadata-and-keywords/search-for-assets.md)
      + [Configuration d’un modèle de métadonnées](workfront-dam/metadata-and-keywords/metadata-templates.md)
      + [Configuration du mappage des métadonnées](workfront-dam/metadata-and-keywords/metadata-mapping.md)
      + [Configuration des mots-clés de métadonnées](workfront-dam/metadata-and-keywords/keyword-setup.md)
      + [Configuration des métadonnées](workfront-dam/metadata-and-keywords/metadata-setup.md)

   + Personnalisation de Brand Connect {#brand-connect-customization}
      + [Présentation [!UICONTROL Brand Connect]?](workfront-dam/brand-connect-customization/what-is-brand-connect.md)
      + [Définition des paramètres système dans [!UICONTROL Brand Connect]](workfront-dam/brand-connect-customization/establish-system-settings.md)
      + [Ajout de pages personnalisées dans [!UICONTROL Brand Connect]](workfront-dam/brand-connect-customization/add-custom-pages-in-brand-connect.md)
      + [Création de directives sur la marque dans [!UICONTROL Brand Connect]](workfront-dam/brand-connect-customization/create-brand-guidelines-in-brand-connect.md)
      + [Personnalisation de l’aspect de [!UICONTROL Brand Connect]](workfront-dam/brand-connect-customization/customize-the-appearance-of-brand-connect.md)
      + [Personnalisation de l’aspect de [!UICONTROL Brand Connect]](workfront-dam/brand-connect-customization/customize-the-look-of-brand-connect.md)

   + Utilisateur DAM Workfront : contributeur {#workfront-dam-contributor}
      + [Comprendre [!UICONTROL Gestion des actifs numériques Workfront] en tant que contributeur](workfront-dam/workfront-dam-user-contributor/contributor-getting-started.md)
      + [Présentation de la gestion des ressources en tant que contributeur](workfront-dam/workfront-dam-user-contributor/contributor-asset-management.md)
      + [Présentation de la recherche de ressources en tant que contributeur](workfront-dam/workfront-dam-user-contributor/contributor-find-assets.md)
      + [Présentation des Lightbox en tant que contributeur](workfront-dam/workfront-dam-user-contributor/contributor-lightboxes.md)
      + [Présentation des métadonnées et des bonnes pratiques relatives aux mots-clés en tant que contributeur](workfront-dam/workfront-dam-user-contributor/metadata-and-keyword-best-practices.md)
      + [Utilisation des ressources en tant que contributeur](workfront-dam/workfront-dam-user-contributor/contributor-work-with-assets.md)
      + [Envoi d’un fichier en tant que contributeur](workfront-dam/workfront-dam-user-contributor/send-a-file-from-workfront-to-workfront-dam.md)
      + [Publication de ressources en tant que contributeur](workfront-dam/workfront-dam-user-contributor/contributor-publish-assets.md)
      + [Ajouter un [!UICONTROL Gestion des actifs numériques Workfront] link](workfront-dam/workfront-dam-user-contributor/add-a-workfront-dam-link-in-workfront.md)

   + Utilisateur de Brand Connect {#brand-connect}
      + [Comprendre [!UICONTROL Brand Connect] en tant qu’utilisateur](workfront-dam/brand-connect-user/brand-connect-introduction.md)
      + [Comprendre [!UICONTROL Brand Connect] notifications](workfront-dam/brand-connect-user/brand-connect-notifications.md)
      + [Comprendre le téléchargement et le partage en tant qu’utilisateur](workfront-dam/brand-connect-user/brand-connect-downloading-and-sharing.md)
      + [Présentation des Lightbox en tant qu’utilisateur](workfront-dam/brand-connect-user/brand-connect-lightboxes.md)
      + [Présentation de la navigation et de la recherche en tant qu’utilisateur](workfront-dam/brand-connect-user/brand-connect-getting-started.md)
...
+ Page d’accueil {#home}
   ...
   + [Communication sur le travail](workfront-home/communicate-about-work-in-workfront-home.md)
   + [Heures de connexion au travail](workfront-home/log-hours-on-work-in-workfront-home.md)
   + [Marquer la tâche affectée comme terminée](workfront-home/mark-assigned-work-as-complete.md)
   + [Approuver le travail dans [!UICONTROL Accueil]](workfront-home/approve-work-in-workfront-home.md)
   + [Collaborer avec [!UICONTROL Mes mises à jour]](workfront-home/collaborate-on-work-with-my-updates.md)
   ...
   + [Présentation des mises à jour et des notifications](manage-work/issues-requests/understand-updates-and-notifications.md)
...
+ Agile {#agile}
   ...
   + Scrum {#scrum}
      ...
      + [Utiliser la page d&#39;itération](agile/using-the-iteration-page.md)

   + Kanban {#kanban}
      + [Création d’une équipe Kanban](agile/create-a-kanban-team.md)
...
+ Bonnes pratiques {#best-practices}
   ...
   + [Performances du système et maintenance](best-practices/system-performance-maintenance-bp.md)
   + [Rapports du mode Texte](best-practices/test-mode-reporting-bp.md)
   + [Planification et gestion du planning](best-practices/timeline-planning-management-bp.md)
...
+ [Avantages d’Agile](agile/benefits-of-using-agile.md)
+ [Quelle est la méthodologie Scrum et comment fonctionne-t-elle ?](agile/what-is-the-scrum-methodology.md)
