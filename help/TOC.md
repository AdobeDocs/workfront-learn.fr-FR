...
+ Fusion {#fusion}
   ...
   + Exercices {#exercises}
      ...
      + [Historique de l’exécution](fusion/12-exercises/execution-history.md)
      ...
      + [Magasins de données](fusion/12-exercises/data-stores.md)
      + [Travailler avec JSON](fusion/12-exercises/working-with-json.md)
...
+ Workfront DAM {#workfront-dam-program}
   ...
   + Utilisateur et utilisatrice Workfront DAM : contributeur et contributrice {#workfront-dam-contributor}
      ...
      + [Comprendre les bonnes pratiques relatives aux métadonnées et aux mots-clés en tant que contributeur ou contributrice](workfront-dam/workfront-dam-user-contributor/metadata-and-keyword-best-practices.md)
...
+ Accueil {#home}
   ...
   + [Comprendre les mises à jour et les notifications](manage-work/issues-requests/understand-updates-and-notifications.md)
