...
La page [!DNL My Updates] simplifie les choses en affichant toutes les demandes d’approbation qui vous sont assignées, ainsi que les mises à jour sur lesquelles vous êtes inclus. Cette page se charge par défaut pour les utilisateurs disposant d’une licence de révision lorsque vous vous connectez à Workfront, sauf si l’administrateur système de votre entreprise a défini une autre page de destination.

![Image de la page [!DNL My Updates]](assets/my-updates-overview.png)

La page [!DNL Home] peut être utilisée à d’autres fins que l’approbation. Si vous avez une licence Travail ou Plan dans Workfront, vos affectations de projets et de requêtes se trouvent dans Accueil. L’Accueil peut correspondre à la page sur laquelle vous accédez lorsque vous vous connectez à Workfront. Vous pouvez également sélectionner Accueil dans le menu principal, selon les configurations du système Workfront de votre entreprise.

![Image de la page [!DNL Home]](assets/home-overview.png)

La section que vous utilisez pour gérer vos demandes d’approbation dépend des processus de révision et d’approbation du travail de votre entreprise. Contactez votre responsable, votre administrateur ou administratrice système ou votre équipe Workfront interne pour déterminer laquelle vous devez utiliser pour prendre le mieux en charge votre workflow.
