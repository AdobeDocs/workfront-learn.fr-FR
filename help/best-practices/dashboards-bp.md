...
Les tableaux de bord et les modèles de mise en page ont souvent un point commun : ils sont conçus pour aider un ensemble spécifique d’utilisateurs et d’utilisatrices à accomplir leur travail. Le partage de tableaux de bord par le biais de modèles de mise en page permet aux équipes d’administration système et de groupes de distribuer rapidement les tableaux de bord et de s’assurer que les utilisateurs et utilisatrices disposent de tous les outils nécessaires, des sections nécessaires de Workfront jusqu’à un rapport présentant leurs dernières affectations.
