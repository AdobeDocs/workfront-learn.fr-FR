...
* **Filtres Personnaliser les rapports de liste :** les filtres dans Workfront permettent aux utilisateurs de réduire les listes (tâches, projets, documents, etc.) en fonction de critères spécifiques, afficher uniquement les éléments qui correspondent aux conditions et sont accessibles à l’utilisateur connecté. &#x200B;
