...
### Tâche : affichez le pourcentage de réalisation du projet de l’prédécesseur de plusieurs projets.
...
## Document - Dates d’approbation du document
...
![Image d’écran affichant la vue Dates d’approbation du document](assets/document-approval-dates.png)
