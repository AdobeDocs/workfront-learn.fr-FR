...
1. Connectez-vous à Workfront et créez des utilisateurs et utilisatrices qui utiliseront la relecture que vous n’avez pas encore créée. Définissez le profil des autorisations d’épreuve dans leurs paramètres d’utilisateur ou d’utilisatrice en fonction du rôle que la personne endossera dans les workflows d’épreuves.
