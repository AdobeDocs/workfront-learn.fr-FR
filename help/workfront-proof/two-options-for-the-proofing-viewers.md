---
title: Description des visionneuses de relecture
description: Découvrez la visionneuse de relecture en ligne et la visionneuse de relecture de bureau de  [!DNL Workfront], la différence entre les deux et comment accéder à chacune d’entre elles.
...
# Description des visionneuses de relecture
...
À la première ouverture d’une épreuve disposant d’un contenu interactif, il vous est demandé de télécharger la visionneuse de relecture de bureau. Suivez simplement les instructions.

Si votre organisation ne vous permet pas d’installer des applications sur votre poste de travail, travaillez avec votre administrateur ou administratrice système pour vous assurer que vous disposez de la visionneuse de relecture dont vous avez besoin.

Une fois l’application de visionneuse de relecture de bureau installée, vos épreuves interactives s’y ouvriront. Il suffit de la télécharger une seule fois.
